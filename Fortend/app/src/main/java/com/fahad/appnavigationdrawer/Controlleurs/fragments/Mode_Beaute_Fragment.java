 ...
 */
public class Mode_Beaute_Fragment extends Fragment {

    RecyclerView mRecyclerView;
    RecyclerView.Adapter mAdapter;

    public Mode_Beaute_Fragment() {
        // Required empty public constructor
    }
    public static Mode_Beaute_Fragment newInstance(){
        return new Mode_Beaute_Fragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_mode__beaute, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.recyclerview_categorie_mode_beaute);
