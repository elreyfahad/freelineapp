...
public class Multimedia_Fragment extends Fragment {
    ...
    public Multimedia_Fragment() {
        // Required empty public constructor
    }

    public static Multimedia_Fragment newInstance(){
        return new Multimedia_Fragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.recyclerview_categorie_multimedia);
