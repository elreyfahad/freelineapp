...
/**
 * Il s'agit d'une classe de vue simple
 * dans laquelle le canvas est utilisé pour rendre
 * la vue avec des trous transparents dans les coins
 */

public class Ticket_Views extends LinearLayout {
    private Bitmap bm;
    private Canvas cv;
    private Paint eraser;
    private int holesBottomMargin = 90;
    private int holeRadius = 40;

    public Ticket_Views(Context context) {
        super(context);
        Init();
    }

    public Ticket_Views(Context context, AttributeSet attrs) {
        super(context, attrs);
        Init();
    }
